  ...
  return (
    <section className="py-20 bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-blue-400/20 to-purple-400/20 dark:from-blue-600/20 dark:to-purple-600/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-orange-400/20 to-pink-400/20 dark:from-orange-600/20 dark:to-pink-600/20 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {apiStats.map((stat: any, index: number) => (
            <motion.div
              ...
              className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all-smooth border border-gray-100 dark:border-gray-700"
            >
          ...
          {apiReasons.map((reason: any, index: number) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <div className="h-full bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-md hover:shadow-2xl transition-all-smooth border border-gray-100 dark:border-gray-700">
                  {/* Icon Container */}
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors-smooth">
                    {reason.title}
                  </h3>
                  ...
                  {/* Hover indicator */}
                  <div className="mt-4 flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold opacity-0 group-hover:opacity-100 transition-opacity-smooth">
