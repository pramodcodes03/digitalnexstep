  ...
  return (
    <footer className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center">
                <span className="text-primary-600 font-bold text-2xl">DN</span>
              </div>
              <div>
                <h3 className="text-xl font-bold">DigitalNexStep</h3>
                <p className="text-sm text-primary-200">Educational Excellence</p>
              </div>
            </div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className={`w-10 h-10 rounded-full bg-white/10 flex items-center justify-center ${social.color} hover:scale-110 transition-all-smooth`}
                  >
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-primary-100 hover:text-white transition-colors-smooth flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              <div className="px-3 py-1 bg-white/10 rounded text-xs">SSL Secure</div>
              <div className="px-3 py-1 bg-white/10 rounded text-xs">Verified</div>
            </div>
          </div>
            ...
            <div>
              ...
              <form onSubmit={handleSubscribe} className="space-y-2">
                <input
                  ...
                  required
                  className="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-primary-200 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all-smooth"
                />
                <button
                  type="submit"
                  disabled={isSubscribing}
                  className="w-full px-4 py-2 bg-white text-primary-700 font-semibold rounded-lg hover:bg-primary-50 transition-colors-smooth disabled:opacity-50"
                >
              ...
              {subscribeStatus === "error" && (
                <p className="text-sm text-red-300 mt-2">Failed to subscribe. Please try again.</p>
              )}
        ...
        <div className="border-t border-white/20 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-primary-200">Accepted Payment Methods:</span>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 right-8 z-50 w-12 h-12 bg-primary-600 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-primary-700 transition-colors-smooth"
