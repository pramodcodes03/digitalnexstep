...
@section('breadcrumb', 'Edit Team Member')
@section('content')
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        <div class="px-6 py-5 border-b border-gray-100">
            <h1 class="text-2xl font-extrabold text-gray-900">Edit Team Member</h1>
        </div>

        <form action="{{ route('admin.team-members.update', $teamMember) }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="designation" id="designation" value="{{ old('designation', $teamMember->designation) }}"
                       class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <textarea name="bio" id="bio" rows="4"
                          class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('bio', $teamMember->bio) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if($teamMember->image)
                    <div class="mb-3">
                        <img src="{{ $teamMember->image }}" alt="{{ $teamMember->name }}" class="w-20 h-20 object-cover rounded-xl border border-gray-200">
                    </div>
                @endif
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="facebook" id="facebook" value="{{ old('facebook', $teamMember->facebook) }}" placeholder="https://facebook.com/..."
                               class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="twitter" id="twitter" value="{{ old('twitter', $teamMember->twitter) }}" placeholder="https://twitter.com/..."
                               class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', $teamMember->linkedin) }}" placeholder="https://linkedin.com/in/..."
                               class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                </div>
            </div>
