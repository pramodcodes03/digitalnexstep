...
@section('breadcrumb', 'Edit Center')

@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
            <div class="px-6 py-5 border-b border-gray-100">
                <h2 class="text-2xl font-extrabold text-gray-900">Edit Center</h2>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.centers.update', $center) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" id="address" rows="2"
                                      class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('address', $center->address) }}</textarea>
                        </div>

                        {{-- City --}}
                        <div>
                            <label for="city" class="block text-sm font-semibold text-gray-700 mb-1">City</label>
                            <input type="text" name="city" id="city" value="{{ old('city', $center->city) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="state" id="state" value="{{ old('state', $center->state) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $center->phone) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="map_url" id="map_url" value="{{ old('map_url', $center->map_url) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $center->latitude) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $center->longitude) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $center->sort_order) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="flex items-end">
                            <label class="inline-flex items-center gap-2">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $center->is_active) ? 'checked' : '' }}
                    ...
                    <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" class="px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-xl hover:bg-blue-700 transition">Update Center</button>
                    </div>
                </form>
            </div>
        </div>
