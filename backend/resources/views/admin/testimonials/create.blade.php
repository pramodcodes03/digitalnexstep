...
@section('breadcrumb', 'Add New Testimonial')
@section('content')
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        <div class="px-6 py-5 border-b border-gray-100">
            <h1 class="text-2xl font-extrabold text-gray-900">Add New Testimonial</h1>
        </div>

        <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="rating" id="rating" value="{{ old('rating', 5) }}" min="1" max="5"
