    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
            <div class="px-6 py-5 border-b border-gray-100">
                <h1 class="text-2xl font-extrabold text-gray-900">Add FAQ</h1>
            </div>
            ...
            <form action="{{ route('admin.faqs.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="answer" id="answer" rows="4" required
                              class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('answer') }}</textarea>
                </div>
