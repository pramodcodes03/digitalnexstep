...
@section('breadcrumb', 'Edit About Section')
@section('content')
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        <div class="px-6 py-5 border-b border-gray-100">
            <h1 class="text-2xl font-extrabold text-gray-900">Edit About Section</h1>
        </div>

        <form action="{{ route('admin.about-sections.update', $aboutSection) }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title', $aboutSection->title) }}" required
            ...
            <div>
                ...
                <input type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $aboutSection->subtitle) }}"
                       class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="5"
                          class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $aboutSection->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if($aboutSection->image)
                    <div class="mb-3">
                        <img src="{{ $aboutSection->image }}" alt="{{ $aboutSection->title }}" class="w-40 h-24 object-cover rounded-xl border border-gray-200">
                    </div>
                @endif
            ...
            <div>
                ...
                <input type="text" name="section_key" id="section_key" value="{{ old('section_key', $aboutSection->section_key) }}"
                       class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="flex items-center gap-3">
                <label for="is_active" class="relative inline-flex items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $aboutSection->is_active) ? 'checked' : '' }}
                           class="sr-only peer">
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $aboutSection->sort_order) }}" min="0"
