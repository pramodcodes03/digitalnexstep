    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
            <div class="px-6 py-5 border-b border-gray-100">
                <h2 class="text-2xl font-extrabold text-gray-900">Edit Achievement</h2>
            </div>
                ...
                <form action="{{ route('admin.achievements.update', $achievement) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="value" id="value" value="{{ old('value', $achievement->value) }}" required
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="suffix" id="suffix" value="{{ old('suffix', $achievement->suffix) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" id="icon" value="{{ old('icon', $achievement->icon) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $achievement->sort_order) }}"
                                   class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $achievement->description) }}</textarea>
                        </div>
                    ...
                    <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" class="px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-xl hover:bg-blue-700 transition">Update Achievement</button>
                    </div>
                </form>
            </div>
        </div>
